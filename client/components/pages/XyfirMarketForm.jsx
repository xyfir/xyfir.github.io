  ...
  render() {
    return (
      <div className="xyfir-market-form-builder">
        ...
        <p>
          Use this form to build a structured sales thread for xyMarket. Check
          the{' '}
          <a
            href="https://github.com/Xyfir/Documentation/blob/master/xyfir-market/help.md"
            target="_blank"
          >
            documentation
          </a>{' '}
        ...
        <p>
          <strong>Warning!</strong> Currently, this form does not validate the
          data you provide, so you will not know if it is correct until
          xyMarketBot validates your post.
        </p>

        <Paper zDepth={1} component="section" className="form section flex">
          <TextField
            id="text--title"
          ...
          <div className="currency flex">
            ...
            {this.state.tracking ? (
              <TextField
                ...
                className="md-cell"
                defaultValue={this.i.currency.value
                  .split(' ')
        ...
        <Button raised primary onClick={() => this.onPost()}>
          Submit
        </Button>
      </div>
    );
