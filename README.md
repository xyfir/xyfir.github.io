This is the code for [xyfir.com](https://xyfir.com), a portal for the Xyfir Network and a catch-all for things that don't fit anywhere else or that are too small to be given their own domain/server/etc.
